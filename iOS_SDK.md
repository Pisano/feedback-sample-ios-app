## pisano ios sdk sample app — iOS SDK Guide

### Supported iOS Versions
Pisano iOS SDK supports iOS 12+ and Xcode 12+ is required.

## Installation Methods

### Manual Installation
You can install Pisano iOS SDK by adding the provided `.xcframework` manually to your project.
...
> TODO (required): Provide your own credentials (do not commit them).  
> Copy `pisano-ios-sdk-sample-app/App/Resources/PisanoSecrets.example.plist` → `PisanoSecrets.plist` and fill:
> `PISANO_APP_ID`, `PISANO_ACCESS_KEY`, `PISANO_API_URL`, `PISANO_FEEDBACK_URL` (and optionally `PISANO_EVENT_URL`).
